...
export const podcasts: Podcast[] = [
  {
    ...
    descriptions: {
      ...
      it: 'The Augmented Intelligence Monitor vi guida attraverso le questioni esistenziali sollevate dall\'IA. Esplorando le profonde implicazioni dell\'intelligenza artificiale sulla nostra vita, le nostre imprese e la nostra societa.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      it: 'La vostra guida definitiva per comprendere, migliorare e sfruttare l\'incredibile potenziale della vostra mentalita. Conoscenze e strumenti per una crescita personale e professionale decisiva.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      it: 'Esplorare la vita sostenibile attraverso l\'alimentazione, la costruzione, il giardinaggio e le nostre interazioni con la flora e la fauna. Come questi elementi si interconnettono con la vita personale, la mentalita e la leadership.',
    },
  ...
  },
  {
    ...
    descriptions: {
      ...
      it: 'Esplorare un quadro di crescita personale e progresso sociale fondato su parentela, inclusivita, premura, disciplina, consapevolezza, integrita, naturalismo e discernimento.',
    },
